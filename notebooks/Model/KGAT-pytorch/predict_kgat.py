...
def predict(args):
    ...
    if args.predict_embed == 0:
        np.save(args.save_dir + 'cf_scores_kgat.npy', cf_scores)
    else:
        np.save(args.save_dir + 'cf_scores_embed.npy', cf_scores)
    print(args.save_dir + 'cf_scores.npy')
    for k in Ks:
