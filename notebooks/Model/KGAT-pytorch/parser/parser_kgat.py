...
def parse_kgat_args():
    ...
    parser.add_argument('--predict_embed', type=int, default=0,
                        help='change saver_name_score.')

    args = parser.parse_args()

    if args.pretrain_embedding_dir != 'datasets/pretrain/':
        save_dir = 'trained_model/KGAT/{}/embed-dim{}_relation-dim{}_{}_{}_{}_lr{}_embedding{}/'.format(
